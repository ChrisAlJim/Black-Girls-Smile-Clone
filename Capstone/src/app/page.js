...
export default function Home() {
  return <div className="flex flex-col">
    {/* Hero Section with Survey Button */}
    <section className="flex flex-col items-center justify-center gap-3 relative h-165 overflow-hidden">
      <div className="bg-black w-full h-full z-1 opacity-50 relative">
    ...
    <section className="flex flex-row justify-center h-180 bg-[#C96C86] items-center gap-40 max-sm:flex-wrap max-sm:gap-20 max-xl:flex-wrap max-xl:gap-20">
      <div className="max-sm:flex max-sm:flex-col max-xl:flex max-xl:flex-col">
        ...
        <div className="max-sm:flex max-sm:justify-center max-xl:flex max-xl:justify-center">
          <Link 
            href="/providers" 
            className="transition-transform duration-300 hover:scale-105 bg-[#DCAD27] text-black font-bold py-2 px-9 rounded-3xl translate-y-20 cursor-pointer max-sm:px-5 max-sm:text-sm max-sm:translate-y-10 max-xl:px-5 max-xl:text-sm max-xl:translate-y-10 inline-block"
          >
            Explore
          </Link>
        </div>
    ...
    <section className="flex flex-row justify-center items-center bg-[#FFF5EA] h-180 gap-40 max-sm:flex max-sm:flex-col max-sm:gap-10 max-xl:flex max-xl:flex-col max-xl:gap-10">
      ...
      <div className="max-xl:flex max-xl:justify-center max-xl:flex-col">
        ...
        <div className="max-sm:flex max-sm:justify-center max-xl:flex max-xl:justify-center">
          <Link 
            href="/resources" 
            className="transition-transform duration-300 hover:scale-105 bg-black text-white font-bold py-2 px-9 rounded-3xl translate-y-20 cursor-pointer max-sm:translate-y-5 max-sm:text-xs max-sm:px-5 max-xl:translate-y-5 max-xl:text-xs max-xl:px-5 inline-block"
          >
            Explore
          </Link>
        </div>
    ...
    <section className="flex flex-row justify-center items-center bg-[#DCAD27] h-180 gap-10 max-sm:flex max-sm:flex-col max-sm:pt-10 max-sm:gap-15 max-xl:flex max-xl:flex-col max-xl:gap-10">
      <div className="max-xl:flex max-xl:justify-center max-xl:flex-col">
        ...
        <div className="max-sm:flex max-sm:justify-center max-xl:flex max-xl:justify-center">
          <Link 
            href="/events" 
            className="transition-transform duration-300 hover:scale-105 bg-[#C96C86] text-white font-bold py-2 px-9 rounded-3xl translate-y-20 cursor-pointer max-sm:translate-y-5 max-sm:text-xs max-sm:px-5 max-xl:translate-y-5 max-xl:text-xs max-xl:px-5 inline-block"
          >
            Explore
          </Link>
        </div>
